...
#include <iostream>
#include <stdexcept>
// define preprocessor macros using #define
#define MAX_SIZE 20
...
public:
    ...
    // Funciton pushes an new element into the data, otherwise throw errors
    void push(T val) {
        ...
        // If there is room in the array, then push the new vaalue into the data
        data[size++] = val;
    }    
