...
int main( ) {
    ...
    // run_tests();  // TODO: Remove before submitting ?? why
    // return 0;
    ...
    // try catch, throw later
        ...
        // something still in the buffer...need to fix that
        // cin.clear();
        // cin.ignore();
        choice = menu();
        // cin.clear();
...
// can check if it is still in the tree, say no if u cna't remove it