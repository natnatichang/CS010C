...
// TO DO, RULE OF 3
// ALSO, ADD FAILS FOR CIN AND TRY AND CATCH BECAUSE U CAN LOL
...
class BSTree {
   ...
   public:
      ...
      // Node::Node(const Node &sourceObject);

      // Node& Node::operator=(const Node &sourceObject);

      // need a rule of 3 for this destructor then 
      ...
      */
      ...
      Node* insertHelper(Node* root, const string &newString);
